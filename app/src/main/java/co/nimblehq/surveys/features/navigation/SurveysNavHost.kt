...
fun SurveysNavHost(
    ...
    startDestination: String = Destination.Splash.destination
) {
    NavHost(
        ...
        composable(destination = Destination.SurveyDetail) { backStackEntry ->
            SurveyDetailScreen(
...
/**
 * Navigate to provided [Destination] with a Pair of key value String and Data [parcel]
