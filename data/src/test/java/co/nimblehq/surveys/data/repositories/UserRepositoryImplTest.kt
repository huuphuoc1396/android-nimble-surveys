...
class UserRepositoryImplTest {
    ...
    @Test
    fun `When fetch user is successful, it saves user to the storage`() = runTest {
        coEvery {
    ...
    @Test
    fun `When fetch user is fail, it throws error`() = runTest {
        val error = Exception()
        coEvery {
            authApiService.getUser()
        } throws error
    ...
    @Test
    fun `When get user is successfully, it emit UserModel`() = runTest {
